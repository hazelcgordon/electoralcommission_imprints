...
*Currently these hypotheses are organised by outcome. Hypothesis 1, 2 and 3 related to informedness; .... **These do not align with the paper draft**, and will need to be renamed once a structure is chosen.*
...
## Hypothesis 2c: outcome: correct versus incorrect recall {.tabset}
